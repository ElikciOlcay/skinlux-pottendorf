...
const faq = [
    ...
    {
        frage: "Wie viele Microneedling-Sitzungen brauche ich?",
        antwort: "Fuer optimale Ergebnisse empfehlen wir 3-6 Sitzungen im Abstand von 4-6 Wochen. Die genaue Anzahl haengt von Ihrem Hautbild und Ihren Zielen ab. Bereits nach der ersten Sitzung sehen Sie eine Verbesserung."
    },
    {
        frage: "Was kostet Microneedling in Pottendorf?",
        antwort: "Eine Microneedling-Behandlung bei Skinlux kostet ab 149 Euro pro Sitzung. Wir bieten auch eine 3er-Kur fuer 499 Euro an (statt 539 Euro einzeln). Die kostenlose Erstberatung ist unverbindlich."
    },
    {
        frage: "Ist Microneedling schmerzhaft?",
        antwort: "Die Behandlung ist gut vertraeglich. Vor der Sitzung tragen wir eine betaeubende Creme auf, sodass Sie waehrend der Behandlung nur ein leichtes Kribbeln spueren. Die meisten Kunden empfinden es als angenehm."
    }
];

export default function MicroneedlingContent() {
    return (
            ...
            <section className="py-16 md:py-20 bg-gray-50">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
                        <Link href="/behandlungen/laser-haarentfernung" className="group p-6 bg-white hover:bg-gray-100 transition-colors">
                            <h3 className="text-lg font-light text-black mb-2 group-hover:text-gray-700">Laser Haarentfernung</h3>
                            <p className="text-sm text-gray-500 font-light">Dauerhafte Haarentfernung mit Diodenlaser-Technologie</p>
                        </Link>
