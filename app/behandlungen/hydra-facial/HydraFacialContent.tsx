...
const faq = [
    ...
    {
        frage: "Was kostet HydraFacial in Pottendorf?",
            ...
            <section className="py-16 md:py-20 bg-gray-50">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
                        ...
                        <Link href="/beratung" className="group p-6 bg-white hover:bg-gray-100 transition-colors">
                            <h3 className="text-lg font-light text-black mb-2 group-hover:text-gray-700">Kostenlose Beratung</h3>
                            <p className="text-sm text-gray-500 font-light">Unverbindliche Beratung und Probebehandlung für Laser</p>
                        </Link>
