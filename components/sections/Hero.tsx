...
export default function Hero() {
    ...
    return (
        <section className="relative min-h-screen flex items-center hero-gradient px-4">
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            {/* Subtitle */}
                            <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-8 font-light px-4">
                                {current.subtitle}
                            </p>
                    ...
                    <motion.div
                        ...
                        className="flex flex-col gap-4 md:gap-6 justify-center px-4"
                    >
                        <a
